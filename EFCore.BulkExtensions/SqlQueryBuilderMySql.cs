    ...
    public static class SqlQueryBuilderMySql
    {
        ...
        public static string InsertIntoTable(TableInfo tableInfo, OperationType operationType, string tableName = null)
        {
            ...
            if (operationType == OperationType.InsertOrUpdate)
            {
                ...
                var commaANDSeparatedPrimaryKeys = SqlQueryBuilder.GetANDSeparatedColumns(primaryKeys);
                var commaSeparatedColumnsEquals = SqlQueryBuilder.GetCommaSeparatedColumns(columnsList);
        ...
        public static string UpdateSetTable(TableInfo tableInfo, string tableName = null)
        {
            ...
            var commaSeparatedPrimaryKeys = SqlQueryBuilder.GetANDSeparatedColumns(primaryKeys);
